...
\textbf{\textit{Power Consumption:}} Since the components in the rod are passive, they would draw a minimal amount of power, powered by the reader. A suitable reader \cite{AS3991BQ49:online} is listed to draw 0.558-1.705W, which is manageable. \\
...
Power Consumption & \cellcolor[HTML]{FCFF2F} && \cellcolor[HTML]{FD6864} && \cellcolor[HTML]{FFFE2F} && \cellcolor[HTML]{FFFE2F} && \cellcolor[HTML]{67FD9A} \\
